...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_add.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5f00", None))
        ...
        self.action_addwithzip.setText(QCoreApplication.translate("MainWindow", u"\u901a\u8fc7zip\u6253\u5f00", None))
